function translate_espanol() {
    const languageFlag = document.getElementById('language-flag');
    languageFlag.src = 'resources/img/Portfolio/Languages/Español.jpg';
    languageFlag.alt = "Español";
    ...
    t_01.innerHTML = "TÉCNICO SUPERIOR EN DESARROLLO DE APLICACIONES MULTIPLATAFORMA";
    ...
    t_17.innerHTML = "Descargar CV";

    let t_18 = document.getElementById("t-18");
    t_18.innerHTML = "Comunicación";

    let t_19 = document.getElementById("t-19");
    t_19.innerHTML = "Trabajo en equipo";

    let t_20 = document.getElementById("t-20");
    t_20.innerHTML = "Creatividad";
    ...
    t_24.innerHTML = "Desarrollo de Aplicaciones Multiplataforma";

    let t_25 = document.getElementById("t-25");
    t_25.innerHTML = "FP Grado Medio";
    ...
    t_95.alt = "Proyecto Slice Delight";
