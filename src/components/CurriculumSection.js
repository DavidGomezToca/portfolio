...
export default function CurriculumSection() {
    ...
    function FormationColumn() {
        return (
            <div className={`curriculum__column formation__column border--${theme}`}>
    ...
    function ExperienceColumn() {
        return (
            <div className={`curriculum__column experience__column border--${theme}`}>
    ...
    function FormationItem({ formation, index }) {
        return (
            <div className={`curriculum__item formation__item background--${theme}--2 border--${theme}`}>
    ...
    function ExperienceItem({ experience, index }) {
        return (
            <div className={`curriculum__item experience__item background--${theme}--2 border--${theme}`}>
